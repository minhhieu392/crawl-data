...
DOCKER_IMAGE=10.0.200.107:5000/web-shop-"$BUILD_TAG":"$BUILD_NUMBER"
ENV_FILE=/home/env/webshop.com.vn/.env.production # Default to dev environment
CONTAINER_NAME=web-shop-"$BUILD_TAG"

if [ "$BUILD_TAG" = "master" ]; then
  ENV_FILE=/home/env/webshop.com.vn/.env.production # Production environment file
elif [ "$BUILD_TAG" = "test" ]; then
  ENV_FILE=/home/env/webshop.com.vn/.env.production # Staging environment file
fi
